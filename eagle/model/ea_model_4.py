        ...
        try:
            if max_new_tokens > 0:
                ...
                if collector is not None:
                    ...
                    with self._stage("teacher_collection"):
                        ...
                        if cfg.source == "response":
                            ...
                            for begin in range(0, prompt_length, cfg.chunk_size):
                                collector.observe(self._head(final[:, begin:begin + cfg.chunk_size]), begin)
                ...
                while ids.shape[1] - prompt_length < max_new_tokens and ids.shape[1] < max_length:
                    ...
                    self.base_model.model.tree_mask = mask
